...
## [0.1.5](https://github.com/OxideAV/oxideav-qoi/compare/v0.1.4...v0.1.5) - 2026-07-09

### Other

- qoi r402: seed the into_equiv fuzz corpus from the chunk_walk seeds
- qoi r402: into_equiv fuzz target — differential of the _into API vs allocating wrappers
- qoi r402: into_equivalence suite — pin the buffer-reuse _into API's correctness + reuse-safety
